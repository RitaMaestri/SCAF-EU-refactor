...
aggregation_path = output_path / "aggregation" / "4_energies"
reformat_path = output_path / "reformat" / "4_energies"
...
# mappings path
sec_map_file = current_path / "mappings" / "map_sectors_4_energies.csv"
...
sectors_order= ["AGRICULTURE","MANUFACTURE","SERVICES","STEEL","CHEMICAL","BIOMASS","COAL","OTHER ENERGY","OIL","GAS","TRANSPORTATION"]
...
reformat_EXIOBASE(aggregation_folder=str(aggregation_path), reformat_folder=str(reformat_path),energy_sectors=["BIOMASS","COAL","OTHER ENERGY","OIL","GAS"],sectors_order=sectors_order)
