...
reformat_path = Path("/home/rita/Documents/Tesi/Projects/SCAF-IAMAX Original/Data_preprocessing/data_calibration_evolution/regional_IOTs")
...
reformat_EXIOBASE(aggregation_folder=str(aggregation_path), reformat_folder=str(reformat_path),sectors_order=sectors_order)
