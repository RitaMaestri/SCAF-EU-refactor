...
repo_root = current_path.parents[2]  # Adjust if repo root is at a different depth
reformat_path = repo_root / "Data_preprocessing" / "data_calibration_evolution" / "regional_IOTs" 
...
reformat_EXIOBASE(aggregation_folder=str(aggregation_path), reformat_folder=str(reformat_path),energy_sectors=["ENERGY"],sectors_order=sectors_order)